...
ruby '2.6.3' # declares the ruby version used by the application
...
#   --Server
gem 'puma',                             '4.3.12'              # Puma is a simple, fast, threaded, and highly concurrent HTTP 1.1 server for Ruby/Rack applications.
#   --UI Related
